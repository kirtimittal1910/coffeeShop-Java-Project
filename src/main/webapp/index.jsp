...
<body>
   <div id= "load-page" class="loader-wrapper">
	...
	<nav class="navbar navbar-expand-lg nav">
		<div class="container">
			<a class="navbar-brand" href="Main.jsp" onmouseover="this.style.color='white'">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto nav-value">
					<li class="nav-item active"><a class="nav-link"
						href="index.jsp"> <font size="+1"> Home </font> <span class="sr-only">(current)</span>
					</a>
					</li>
					...
					<a	class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
						...
						aria-expanded="false"> <font size="+1"> Menu </font>  </a>

						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item" href="Main.jsp?category=all"
								id="allProducts"> <font size="+1"> All Products </font> </a>
							<%
							for (Category c : list) {
							%>
				...
				<ul class="navbar-nav ml-auto nav-value">
						...
						<li class="nav-item active"><a class="nav-link" href="#"
							data-toggle="modal" data-target="#cart"> <font size="+1"><img class="icon"
								alt="cart-icon" src="img/cart-icon.png"><span
						...
						<li class="nav-item active"><a class="nav-link"
							href="<%=U.getUserType().equals("admin") ? "admin.jsp" : "normal.jsp"%>">
								<font size="+1"> <%=U.getUserName()%> </font> </a></li>
	...
	<div id="header-title">
		...
		<input class="menu" type="button" value="Explore The Menu" onclick="window.location.href='Main.jsp'">
	</div>
